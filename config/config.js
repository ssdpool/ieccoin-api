...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\IvugeoEvolutionCoin\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/IvugeoEvolutionCoin/';
  if (isLinux) dataDir = process.env.HOME + '~/.IvugeoEvolutionCoin/';
}
